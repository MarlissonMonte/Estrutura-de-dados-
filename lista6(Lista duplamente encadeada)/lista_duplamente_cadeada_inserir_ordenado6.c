...
NO *atual = l->cabeca;
    ...
    newNode->ant = anterior; // Ajusta o ponteiro do novo nO para apontar para o nO anterior
    newNode->prox = atual;   // Ajusta o ponteiro do novo nO para apontar para o nO posterior
    l->tamanho++;
