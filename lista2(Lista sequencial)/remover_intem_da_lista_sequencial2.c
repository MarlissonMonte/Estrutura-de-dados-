...
//A função deve retornar um valor booleano. Caso a posição esteja no intervalo de 0 <= posição < tamanho,
// deve ser possível remover o item e reduzir o tamanho da lista.
// Caso contrário, a função deve apenas retornar false para indicar que a remoção não foi feita
